...
#insert scripts\zm\_bonuscard.gsh;
...
function challengeKills( data, time )
{
	...
	{
		if ( player IsBonusCardActive( BONUSCARD_PRIMARY_GUNFIGHTER, player.class_num ) )
		{
		...
		if ( isdefined( player.secondaryWeaponKill ) && player.secondaryWeaponKill == true )
		{
			...
			if ( player IsBonusCardActive( BONUSCARD_OVERKILL, player.class_num ) )
			{
	...
	{
		if ( player IsBonusCardActive( BONUSCARD_SECONDARY_GUNFIGHTER, player.class_num ) )
		{
	...
	if ( player IsBonusCardActive( BONUSCARD_PERK_3_GREED, player.class_num )
		|| player IsBonusCardActive( BONUSCARD_PERK_2_GREED, player.class_num ) 
		|| player IsBonusCardActive( BONUSCARD_PERK_1_GREED, player.class_num ) )
	{
	...
	{
		if ( player IsBonusCardActive( BONUSCARD_DANGER_CLOSE, player.class_num ) )
		{
