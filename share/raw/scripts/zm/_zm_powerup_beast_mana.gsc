...
function __init__()
{
	...
	{
		zm_powerups::add_zombie_powerup( "beast_mana",	"zombie_z_money_icon", &"ZM_ZOD_POWERUP_BEAST_MANA",	&zm_powerups::func_should_never_drop, POWERUP_ONLY_AFFECTS_GRABBER, !POWERUP_ANY_TEAM, !POWERUP_ZOMBIE_GRABBABLE );
	}
}
...
function beast_mana_powerup( item, player )
{
	...
	for ( i = 0; i < players.size; i++ )
	{
		...
		{
			if ( IS_TRUE( players[i].beastmode ) )
			{
